...
public class GUI {
    ...
    private GUI(){
        ...
        fastItem.addActionListener(e -> fastButton.doClick());
        ...
        sonicItem.addActionListener(e -> sonicButton.doClick());
